...
export default function MainPage() {
    ...
    // 온보딩 리마인더 체크 (DB: onboarding_completed, localStorage: 24시간 체크)
    useEffect(() => {
        ...
        // Backend는 onboarding_completed (boolean) 반환
        const isCompleted = !!user.onboarding_completed;
        console.log('  - onboarding_completed (DB):', user.onboarding_completed);
