...
export default function OnboardingCompletePage() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // ✅ localStorage의 user 정보 업데이트 (onboarding_completed를 true로)
            ...
            if (savedUser && savedUser.id) {
                ...
                storage.setItem('user', JSON.stringify(savedUser));
                console.log('✅ localStorage user 정보 업데이트: onboarding_completed = true');
            }
            ...
            <div className="max-w-5xl w-full">
                ...
                <div className="flex gap-4 justify-center">
                    ...
                    {!isFromReminderModal && (
                        <button
                            onClick={() => {
                                // ✅ reset() 제거 - 선택한 OTT와 영화 유지
                                console.log("✅ 다시 선택하기 - 기존 선택 유지");
                                // OTT 선택 페이지부터 다시 시작
